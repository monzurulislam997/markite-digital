...
const Contact = () => {
    return (
        <div>
            ...
            <div className='flex flex-col lg:flex-row  py-10 px-10' >
                <div class="p-6 w-full  lg:w-1/2 border-2 shadow-2xl sm:rounded-md">
                    <form>
          ...
          "
                ...
                <div className='lg:w-1/2 order-1 w-full px-16'>
                    <img src={img} alt="" />
                </div>
            </div>
        </div>
